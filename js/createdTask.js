    ...
    static createdTaskHTML(task, date, id, completed) {
        ...
        <div class="task__list__item" id="${id}">
            ...
            <div class="task__list__item__btns">
                <button class="btn task__list__item__btn btn--completed ${completed ? "btn--blue" : "btn--green"}" onclick="NewTask.completedTask(${id})" data-completed="${id}" title="doble click para cancelar"><img src="./assets/done.png" alt="completar tarea"></button>
...
console.log(btnInvalidTask);

btnCreatedask.addEventListener('click', () => {
    if(inputTask.value !== ''){return createdTaskInfo(inputTask.value), inputTask.value = ''};
